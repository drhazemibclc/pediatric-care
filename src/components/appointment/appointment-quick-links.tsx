  ...
  return (
    <Card className='w-full rounded-xl bg-white shadow-none'>
      ...
      <CardContent className='flex flex-wrap gap-2'>
        ...
        <Link href='?cat=diagnosis' className='rounded-lg bg-blue-100 px-4 py-2 text-blue-600'>
          Diagnosis
        </Link>

        <Link href='?cat=billing' className='rounded-lg bg-green-100 px-4 py-2 text-green-600'>
          Bills
        </Link>

        <Link href='?cat=medical-history' className='rounded-lg bg-red-100 px-4 py-2 text-red-600'>
          Medical History
        </Link>

        <Link href='?cat=payments' className='rounded-lg bg-purple-100 px-4 py-2 text-purple-600'>
          Payments
        </Link>

        <Link href='?cat=lab-test' className='rounded-lg bg-purple-100 px-4 py-2 text-purple-600'>
          Lab Test
        </Link>
