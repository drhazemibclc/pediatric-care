...
export const PatientBillsFindFirstOrThrowArgsSchema: z.ZodType<Prisma.PatientBillsFindFirstOrThrowArgs> =
  z
    .object({
...
export default PatientBillsFindFirstOrThrowArgsSchema;
