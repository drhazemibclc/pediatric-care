...
export const VitalSignsUpdateManyAndReturnArgsSchema: z.ZodType<Prisma.VitalSignsUpdateManyAndReturnArgs> =
  z
    .object({
      data: z.union([
...
export default VitalSignsUpdateManyAndReturnArgsSchema;
