...
export const WorkingDaysFindFirstOrThrowArgsSchema: z.ZodType<Prisma.WorkingDaysFindFirstOrThrowArgs> =
  z
    .object({
...
export default WorkingDaysFindFirstOrThrowArgsSchema;
