...
export const DoctorUncheckedUpdateWithoutAppointmentsInputSchema: z.ZodType<Prisma.DoctorUncheckedUpdateWithoutAppointmentsInput> =
  z
    .object({
...
export default DoctorUncheckedUpdateWithoutAppointmentsInputSchema;
