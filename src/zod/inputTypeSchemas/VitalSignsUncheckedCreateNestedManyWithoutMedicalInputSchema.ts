...
export const VitalSignsUncheckedCreateNestedManyWithoutMedicalInputSchema: z.ZodType<Prisma.VitalSignsUncheckedCreateNestedManyWithoutMedicalInput> =
  z
    .object({
      create: z
        .union([
...
export default VitalSignsUncheckedCreateNestedManyWithoutMedicalInputSchema;
