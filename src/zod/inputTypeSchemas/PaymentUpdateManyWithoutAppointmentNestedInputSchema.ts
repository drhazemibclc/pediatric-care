...
export const PaymentUpdateManyWithoutAppointmentNestedInputSchema: z.ZodType<Prisma.PaymentUpdateManyWithoutAppointmentNestedInput> =
  z
    .object({
      create: z
        .union([
...
export default PaymentUpdateManyWithoutAppointmentNestedInputSchema;
