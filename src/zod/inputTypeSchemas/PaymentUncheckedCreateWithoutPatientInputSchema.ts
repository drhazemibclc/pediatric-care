...
export const PaymentUncheckedCreateWithoutPatientInputSchema: z.ZodType<Prisma.PaymentUncheckedCreateWithoutPatientInput> =
  z
    .object({
...
export default PaymentUncheckedCreateWithoutPatientInputSchema;
