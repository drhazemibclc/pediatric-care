...
export const MedicalRecordsUpdateWithoutVital_signsInputSchema: z.ZodType<Prisma.MedicalRecordsUpdateWithoutVital_signsInput> =
  z
    .object({
      doctor_id: z
...
export default MedicalRecordsUpdateWithoutVital_signsInputSchema;
