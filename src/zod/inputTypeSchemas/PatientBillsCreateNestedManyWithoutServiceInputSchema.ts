...
export const PatientBillsCreateNestedManyWithoutServiceInputSchema: z.ZodType<Prisma.PatientBillsCreateNestedManyWithoutServiceInput> =
  z
    .object({
      create: z
        .union([
...
export default PatientBillsCreateNestedManyWithoutServiceInputSchema;
