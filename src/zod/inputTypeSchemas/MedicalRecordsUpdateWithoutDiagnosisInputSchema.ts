...
export const MedicalRecordsUpdateWithoutDiagnosisInputSchema: z.ZodType<Prisma.MedicalRecordsUpdateWithoutDiagnosisInput> =
  z
    .object({
      doctor_id: z
...
export default MedicalRecordsUpdateWithoutDiagnosisInputSchema;
