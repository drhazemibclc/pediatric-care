...
export const MedicalRecordsUpdateManyWithoutPatientNestedInputSchema: z.ZodType<Prisma.MedicalRecordsUpdateManyWithoutPatientNestedInput> =
  z
    .object({
      create: z
        .union([
...
export default MedicalRecordsUpdateManyWithoutPatientNestedInputSchema;
