...
export const DiagnosisUpdateWithoutDoctorInputSchema: z.ZodType<Prisma.DiagnosisUpdateWithoutDoctorInput> =
  z
    .object({
      patient_id: z
...
export default DiagnosisUpdateWithoutDoctorInputSchema;
