...
export const AppointmentCreateNestedManyWithoutDoctorInputSchema: z.ZodType<Prisma.AppointmentCreateNestedManyWithoutDoctorInput> =
  z
    .object({
      create: z
        .union([
...
export default AppointmentCreateNestedManyWithoutDoctorInputSchema;
