...
export const PatientUncheckedCreateWithoutMedicalInputSchema: z.ZodType<Prisma.PatientUncheckedCreateWithoutMedicalInput> =
  z
    .object({
      id: z.string(),
      first_name: z.string(),
...
export default PatientUncheckedCreateWithoutMedicalInputSchema;
