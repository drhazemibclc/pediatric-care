...
export const MedicalRecordsUncheckedUpdateInputSchema: z.ZodType<Prisma.MedicalRecordsUncheckedUpdateInput> =
  z
    .object({
...
export default MedicalRecordsUncheckedUpdateInputSchema;
