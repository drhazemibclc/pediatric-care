...
export const PatientBillsUncheckedCreateNestedManyWithoutPaymentInputSchema: z.ZodType<Prisma.PatientBillsUncheckedCreateNestedManyWithoutPaymentInput> =
  z
    .object({
      create: z
        .union([
...
export default PatientBillsUncheckedCreateNestedManyWithoutPaymentInputSchema;
