...
export const MedicalRecordsUncheckedCreateWithoutDiagnosisInputSchema: z.ZodType<Prisma.MedicalRecordsUncheckedCreateWithoutDiagnosisInput> =
  z
    .object({
...
export default MedicalRecordsUncheckedCreateWithoutDiagnosisInputSchema;
