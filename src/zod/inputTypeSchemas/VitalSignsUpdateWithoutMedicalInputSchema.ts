...
export const VitalSignsUpdateWithoutMedicalInputSchema: z.ZodType<Prisma.VitalSignsUpdateWithoutMedicalInput> =
  z
    .object({
      patient_id: z
...
export default VitalSignsUpdateWithoutMedicalInputSchema;
