...
export const MedicalRecordsUpdateWithoutLab_testInputSchema: z.ZodType<Prisma.MedicalRecordsUpdateWithoutLab_testInput> =
  z
    .object({
      doctor_id: z
...
export default MedicalRecordsUpdateWithoutLab_testInputSchema;
