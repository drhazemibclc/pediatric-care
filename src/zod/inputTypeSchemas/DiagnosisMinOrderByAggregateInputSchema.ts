...
export const DiagnosisMinOrderByAggregateInputSchema: z.ZodType<Prisma.DiagnosisMinOrderByAggregateInput> =
  z
    .object({
...
export default DiagnosisMinOrderByAggregateInputSchema;
