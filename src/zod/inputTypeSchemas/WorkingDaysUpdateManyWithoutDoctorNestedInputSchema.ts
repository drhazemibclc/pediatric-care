...
export const WorkingDaysUpdateManyWithoutDoctorNestedInputSchema: z.ZodType<Prisma.WorkingDaysUpdateManyWithoutDoctorNestedInput> =
  z
    .object({
      create: z
        .union([
...
export default WorkingDaysUpdateManyWithoutDoctorNestedInputSchema;
