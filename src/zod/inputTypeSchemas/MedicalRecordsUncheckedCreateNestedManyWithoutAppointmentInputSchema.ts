...
export const MedicalRecordsUncheckedCreateNestedManyWithoutAppointmentInputSchema: z.ZodType<Prisma.MedicalRecordsUncheckedCreateNestedManyWithoutAppointmentInput> =
  z
    .object({
      create: z
        .union([
...
export default MedicalRecordsUncheckedCreateNestedManyWithoutAppointmentInputSchema;
