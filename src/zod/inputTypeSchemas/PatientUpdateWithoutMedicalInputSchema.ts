...
export const PatientUpdateWithoutMedicalInputSchema: z.ZodType<Prisma.PatientUpdateWithoutMedicalInput> =
  z
    .object({
...
export default PatientUpdateWithoutMedicalInputSchema;
