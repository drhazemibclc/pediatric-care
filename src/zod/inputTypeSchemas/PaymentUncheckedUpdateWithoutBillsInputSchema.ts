...
export const PaymentUncheckedUpdateWithoutBillsInputSchema: z.ZodType<Prisma.PaymentUncheckedUpdateWithoutBillsInput> =
  z
    .object({
...
export default PaymentUncheckedUpdateWithoutBillsInputSchema;
