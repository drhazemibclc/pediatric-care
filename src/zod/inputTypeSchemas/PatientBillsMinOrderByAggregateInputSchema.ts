...
export const PatientBillsMinOrderByAggregateInputSchema: z.ZodType<Prisma.PatientBillsMinOrderByAggregateInput> =
  z
    .object({
...
export default PatientBillsMinOrderByAggregateInputSchema;
