...
export const VitalSignsUncheckedUpdateWithoutMedicalInputSchema: z.ZodType<Prisma.VitalSignsUncheckedUpdateWithoutMedicalInput> =
  z
    .object({
...
export default VitalSignsUncheckedUpdateWithoutMedicalInputSchema;
