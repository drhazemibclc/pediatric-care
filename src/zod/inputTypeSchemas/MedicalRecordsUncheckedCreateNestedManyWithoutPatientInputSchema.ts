...
export const MedicalRecordsUncheckedCreateNestedManyWithoutPatientInputSchema: z.ZodType<Prisma.MedicalRecordsUncheckedCreateNestedManyWithoutPatientInput> =
  z
    .object({
      create: z
        .union([
...
export default MedicalRecordsUncheckedCreateNestedManyWithoutPatientInputSchema;
