...
export const LabTestCreateNestedManyWithoutMedical_recordInputSchema: z.ZodType<Prisma.LabTestCreateNestedManyWithoutMedical_recordInput> =
  z
    .object({
      create: z
        .union([
...
export default LabTestCreateNestedManyWithoutMedical_recordInputSchema;
