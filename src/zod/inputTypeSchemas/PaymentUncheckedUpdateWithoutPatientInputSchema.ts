...
export const PaymentUncheckedUpdateWithoutPatientInputSchema: z.ZodType<Prisma.PaymentUncheckedUpdateWithoutPatientInput> =
  z
    .object({
...
export default PaymentUncheckedUpdateWithoutPatientInputSchema;
