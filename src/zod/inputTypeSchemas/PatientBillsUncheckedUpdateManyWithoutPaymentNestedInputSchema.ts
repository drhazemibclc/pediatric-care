...
export const PatientBillsUncheckedUpdateManyWithoutPaymentNestedInputSchema: z.ZodType<Prisma.PatientBillsUncheckedUpdateManyWithoutPaymentNestedInput> =
  z
    .object({
      create: z
        .union([
...
export default PatientBillsUncheckedUpdateManyWithoutPaymentNestedInputSchema;
