...
export const DiagnosisCreateNestedManyWithoutMedicalInputSchema: z.ZodType<Prisma.DiagnosisCreateNestedManyWithoutMedicalInput> =
  z
    .object({
      create: z
        .union([
...
export default DiagnosisCreateNestedManyWithoutMedicalInputSchema;
