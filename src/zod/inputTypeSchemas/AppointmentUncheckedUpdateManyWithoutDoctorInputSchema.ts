...
export const AppointmentUncheckedUpdateManyWithoutDoctorInputSchema: z.ZodType<Prisma.AppointmentUncheckedUpdateManyWithoutDoctorInput> =
  z
    .object({
...
export default AppointmentUncheckedUpdateManyWithoutDoctorInputSchema;
