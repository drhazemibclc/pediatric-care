...
export const LabTestUpdateManyWithoutMedical_recordNestedInputSchema: z.ZodType<Prisma.LabTestUpdateManyWithoutMedical_recordNestedInput> =
  z
    .object({
      create: z
        .union([
...
export default LabTestUpdateManyWithoutMedical_recordNestedInputSchema;
