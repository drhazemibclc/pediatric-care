...
export const PatientUncheckedUpdateWithoutMedicalInputSchema: z.ZodType<Prisma.PatientUncheckedUpdateWithoutMedicalInput> =
  z
    .object({
...
export default PatientUncheckedUpdateWithoutMedicalInputSchema;
