...
export const MedicalRecordsMaxOrderByAggregateInputSchema: z.ZodType<Prisma.MedicalRecordsMaxOrderByAggregateInput> =
  z
    .object({
...
export default MedicalRecordsMaxOrderByAggregateInputSchema;
