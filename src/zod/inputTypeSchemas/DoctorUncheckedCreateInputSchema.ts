...
export const DoctorUncheckedCreateInputSchema: z.ZodType<Prisma.DoctorUncheckedCreateInput> = z
  .object({
    id: z.string(),
    email: z.string(),
    name: z.string(),
    ...
    diagnosis: z.lazy(() => DiagnosisUncheckedCreateNestedManyWithoutDoctorInputSchema).optional(),
  })
  .strict();

export default DoctorUncheckedCreateInputSchema;
