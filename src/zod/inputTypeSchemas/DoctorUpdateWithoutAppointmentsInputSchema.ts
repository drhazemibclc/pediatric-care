...
export const DoctorUpdateWithoutAppointmentsInputSchema: z.ZodType<Prisma.DoctorUpdateWithoutAppointmentsInput> =
  z
    .object({
...
export default DoctorUpdateWithoutAppointmentsInputSchema;
