...
export const PatientBillsCountOrderByAggregateInputSchema: z.ZodType<Prisma.PatientBillsCountOrderByAggregateInput> =
  z
    .object({
...
export default PatientBillsCountOrderByAggregateInputSchema;
