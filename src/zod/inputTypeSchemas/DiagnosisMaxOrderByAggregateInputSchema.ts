...
export const DiagnosisMaxOrderByAggregateInputSchema: z.ZodType<Prisma.DiagnosisMaxOrderByAggregateInput> =
  z
    .object({
...
export default DiagnosisMaxOrderByAggregateInputSchema;
