...
export const VitalSignsMaxOrderByAggregateInputSchema: z.ZodType<Prisma.VitalSignsMaxOrderByAggregateInput> =
  z
    .object({
...
export default VitalSignsMaxOrderByAggregateInputSchema;
