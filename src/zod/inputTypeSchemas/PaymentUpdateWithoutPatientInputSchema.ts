...
export const PaymentUpdateWithoutPatientInputSchema: z.ZodType<Prisma.PaymentUpdateWithoutPatientInput> =
  z
    .object({
      bill_id: z
...
export default PaymentUpdateWithoutPatientInputSchema;
