...
export const PatientCreateWithoutRatingsInputSchema: z.ZodType<Prisma.PatientCreateWithoutRatingsInput> =
  z
    .object({
      id: z.string(),
      first_name: z.string(),
...
export default PatientCreateWithoutRatingsInputSchema;
