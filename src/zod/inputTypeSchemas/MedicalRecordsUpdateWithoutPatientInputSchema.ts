...
export const MedicalRecordsUpdateWithoutPatientInputSchema: z.ZodType<Prisma.MedicalRecordsUpdateWithoutPatientInput> =
  z
    .object({
      doctor_id: z
...
export default MedicalRecordsUpdateWithoutPatientInputSchema;
