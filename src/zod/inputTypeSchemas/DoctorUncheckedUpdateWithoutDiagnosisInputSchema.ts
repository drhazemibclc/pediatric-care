...
export const DoctorUncheckedUpdateWithoutDiagnosisInputSchema: z.ZodType<Prisma.DoctorUncheckedUpdateWithoutDiagnosisInput> =
  z
    .object({
...
export default DoctorUncheckedUpdateWithoutDiagnosisInputSchema;
