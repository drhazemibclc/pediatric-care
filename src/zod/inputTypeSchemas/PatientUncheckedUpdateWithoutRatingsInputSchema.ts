...
export const PatientUncheckedUpdateWithoutRatingsInputSchema: z.ZodType<Prisma.PatientUncheckedUpdateWithoutRatingsInput> =
  z
    .object({
...
export default PatientUncheckedUpdateWithoutRatingsInputSchema;
