...
export const PatientUncheckedCreateWithoutRatingsInputSchema: z.ZodType<Prisma.PatientUncheckedCreateWithoutRatingsInput> =
  z
    .object({
      id: z.string(),
      first_name: z.string(),
...
export default PatientUncheckedCreateWithoutRatingsInputSchema;
