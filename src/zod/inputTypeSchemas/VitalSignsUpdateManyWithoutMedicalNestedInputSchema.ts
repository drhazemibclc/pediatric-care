...
export const VitalSignsUpdateManyWithoutMedicalNestedInputSchema: z.ZodType<Prisma.VitalSignsUpdateManyWithoutMedicalNestedInput> =
  z
    .object({
      create: z
        .union([
...
export default VitalSignsUpdateManyWithoutMedicalNestedInputSchema;
