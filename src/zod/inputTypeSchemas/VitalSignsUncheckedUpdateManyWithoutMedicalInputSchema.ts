...
export const VitalSignsUncheckedUpdateManyWithoutMedicalInputSchema: z.ZodType<Prisma.VitalSignsUncheckedUpdateManyWithoutMedicalInput> =
  z
    .object({
...
export default VitalSignsUncheckedUpdateManyWithoutMedicalInputSchema;
