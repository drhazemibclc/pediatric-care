...
export const MedicalRecordsCountOrderByAggregateInputSchema: z.ZodType<Prisma.MedicalRecordsCountOrderByAggregateInput> =
  z
    .object({
...
export default MedicalRecordsCountOrderByAggregateInputSchema;
