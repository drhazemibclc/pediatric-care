...
export const PatientBillsUncheckedUpdateManyWithoutServiceNestedInputSchema: z.ZodType<Prisma.PatientBillsUncheckedUpdateManyWithoutServiceNestedInput> =
  z
    .object({
      create: z
        .union([
...
export default PatientBillsUncheckedUpdateManyWithoutServiceNestedInputSchema;
