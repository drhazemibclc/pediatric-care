...
export const AppointmentUncheckedUpdateWithoutBillsInputSchema: z.ZodType<Prisma.AppointmentUncheckedUpdateWithoutBillsInput> =
  z
    .object({
...
export default AppointmentUncheckedUpdateWithoutBillsInputSchema;
