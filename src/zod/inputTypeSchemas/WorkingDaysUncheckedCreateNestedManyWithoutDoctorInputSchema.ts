...
export const WorkingDaysUncheckedCreateNestedManyWithoutDoctorInputSchema: z.ZodType<Prisma.WorkingDaysUncheckedCreateNestedManyWithoutDoctorInput> =
  z
    .object({
      create: z
        .union([
...
export default WorkingDaysUncheckedCreateNestedManyWithoutDoctorInputSchema;
