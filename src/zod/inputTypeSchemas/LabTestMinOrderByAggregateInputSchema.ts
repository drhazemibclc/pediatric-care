...
export const LabTestMinOrderByAggregateInputSchema: z.ZodType<Prisma.LabTestMinOrderByAggregateInput> =
  z
    .object({
...
export default LabTestMinOrderByAggregateInputSchema;
