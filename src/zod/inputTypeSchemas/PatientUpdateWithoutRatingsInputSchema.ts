...
export const PatientUpdateWithoutRatingsInputSchema: z.ZodType<Prisma.PatientUpdateWithoutRatingsInput> =
  z
    .object({
...
export default PatientUpdateWithoutRatingsInputSchema;
