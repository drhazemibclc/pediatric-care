...
export const PaymentUncheckedCreateWithoutBillsInputSchema: z.ZodType<Prisma.PaymentUncheckedCreateWithoutBillsInput> =
  z
    .object({
...
export default PaymentUncheckedCreateWithoutBillsInputSchema;
