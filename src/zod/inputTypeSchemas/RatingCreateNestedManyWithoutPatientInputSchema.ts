...
export const RatingCreateNestedManyWithoutPatientInputSchema: z.ZodType<Prisma.RatingCreateNestedManyWithoutPatientInput> =
  z
    .object({
      create: z
        .union([
...
export default RatingCreateNestedManyWithoutPatientInputSchema;
