...
export const MedicalRecordsCreateWithoutPatientInputSchema: z.ZodType<Prisma.MedicalRecordsCreateWithoutPatientInput> =
  z
    .object({
      doctor_id: z.string(),
...
export default MedicalRecordsCreateWithoutPatientInputSchema;
