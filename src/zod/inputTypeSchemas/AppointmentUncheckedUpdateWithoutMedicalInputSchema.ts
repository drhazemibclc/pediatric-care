...
export const AppointmentUncheckedUpdateWithoutMedicalInputSchema: z.ZodType<Prisma.AppointmentUncheckedUpdateWithoutMedicalInput> =
  z
    .object({
...
export default AppointmentUncheckedUpdateWithoutMedicalInputSchema;
