...
export const DiagnosisUpdateManyWithoutDoctorNestedInputSchema: z.ZodType<Prisma.DiagnosisUpdateManyWithoutDoctorNestedInput> =
  z
    .object({
      create: z
        .union([
...
export default DiagnosisUpdateManyWithoutDoctorNestedInputSchema;
